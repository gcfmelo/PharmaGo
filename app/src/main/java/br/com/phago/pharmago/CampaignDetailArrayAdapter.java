...
class CampaignDetailArrayAdapter extends ArrayAdapter<CampaignListClass>{
    ...
    public CampaignDetailArrayAdapter(Context context, List<CampaignListClass> camplist){
